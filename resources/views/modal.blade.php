            ...
            <div class="modal-body">
                <div class="row">
                    <div class="col mb-3">
                        ...
                        <input type="text" id="codeAspek" name="aspek_id" class="form-control" readonly value="A001">
                    </div>
                </div>
                <div class="row">
                    <div class="col mb-3">
            ...
            <div class="modal-body">
                <div class="row">
                    <div class="col mb-3">
                        ...
                        <input type="text" id="codeIndikator" name="indikator_id" class="form-control" readonly value="A001">
                    </div>
                </div>
                <div class="row">
                    <div class="col mb-3">
